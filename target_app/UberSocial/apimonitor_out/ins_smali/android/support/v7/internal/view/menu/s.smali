...
.field static final b:Ljava/lang/String; = "MenuItemWrapper"
...
move-result v0
iput-boolean v0, p0, Landroid/support/v7/internal/view/menu/s;->d:Z
iput-boolean p2, p0, Landroid/support/v7/internal/view/menu/s;->c:Z
return-void
.end method
...
return v0
.end method
.method static synthetic b(Landroid/support/v7/internal/view/menu/s;)Z
.registers 2
iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/s;->d:Z
return v0
.end method
.method  a(Landroid/support/v4/view/ActionProvider;)Landroid/support/v7/internal/view/menu/t;
.registers 3
new-instance v0, Landroid/support/v7/internal/view/menu/t;
invoke-direct {v0, p0, p1}, Landroid/support/v7/internal/view/menu/t;-><init>(Landroid/support/v7/internal/view/menu/s;Landroid/support/v4/view/ActionProvider;)V
return-object v0
.end method
.method public a(Z)V
.registers 7
:try_start_0
iget-object v0, p0, Landroid/support/v7/internal/view/menu/s;->e:Ljava/lang/reflect/Method;
if-nez v0, :cond_1c
...
move-result-object v0
iput-object v0, p0, Landroid/support/v7/internal/view/menu/s;->e:Ljava/lang/reflect/Method;
:cond_1c
iget-object v0, p0, Landroid/support/v7/internal/view/menu/s;->e:Ljava/lang/reflect/Method;
...
.registers 4
const/4 v0, 0x0
iget-boolean v1, p0, Landroid/support/v7/internal/view/menu/s;->d:Z
if-eqz v1, :cond_1b
invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/s;->getSupportActionProvider()Landroid/support/v4/view/ActionProvider;
...
move-result v1
if-nez v1, :cond_1b
invoke-virtual {p0, v0}, Landroid/support/v7/internal/view/menu/s;->b(Z)Landroid/view/MenuItem;
const/4 v0, 0x1
:cond_1b
return v0
.end method
...
invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/u;->a()Landroid/view/View;
move-result-object v0
:cond_12
return-object v0
.end method
...
invoke-interface {v0}, Landroid/view/MenuItem;->getActionView()Landroid/view/View;
move-result-object v1
instance-of v0, v1, Landroid/support/v7/b/c;
if-eqz v0, :cond_1f
iget-object v0, p0, Landroid/support/v7/internal/view/menu/s;->a:Ljava/lang/Object;
check-cast v0, Landroid/view/MenuItem;
...
invoke-direct {v1, p0, p1}, Landroid/support/v7/internal/view/menu/w;-><init>(Landroid/support/v7/internal/view/menu/s;Landroid/view/MenuItem$OnMenuItemClickListener;)V
:goto_b
...
check-cast v0, Landroid/view/MenuItem;
if-eqz p1, :cond_e
invoke-virtual {p0, p1}, Landroid/support/v7/internal/view/menu/s;->a(Landroid/support/v4/view/ActionProvider;)Landroid/support/v7/internal/view/menu/t;
move-result-object v1
:goto_a
...
invoke-direct {v1, p0, p1}, Landroid/support/v7/internal/view/menu/v;-><init>(Landroid/support/v7/internal/view/menu/s;Landroid/support/v4/view/MenuItemCompat$OnActionExpandListener;)V
:goto_c
...
iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/s;->c:Z
if-eqz v0, :cond_d
iput-boolean p1, p0, Landroid/support/v7/internal/view/menu/s;->d:Z
invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/s;->c()Z
move-result v0
if-eqz v0, :cond_d
:goto_c
return-object p0
:cond_d
invoke-virtual {p0, p1}, Landroid/support/v7/internal/view/menu/s;->b(Z)Landroid/view/MenuItem;
