...
.field private e:Landroid/support/v7/internal/view/menu/p;
.field private f:Z
.field private g:Z
.field private h:I
.field private i:I
...
sget v1, Landroid/support/v7/a/e;->abc_config_allowActionMenuItemTextWithIcon:I
invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getBoolean(I)Z
move-result v0
iput-boolean v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->f:Z
sget-object v0, Landroid/support/v7/a/n;->ActionMenuItemView:[I
invoke-virtual {p1, p2, v0, v2, v2}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
move-result-object v0
invoke-virtual {v0, v2, v2}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I
move-result v1
iput v1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->h:I
...
const/4 v1, 0x1
const/4 v2, 0x0
iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->c:Ljava/lang/CharSequence;
invoke-static {v0}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z
move-result v0
if-nez v0, :cond_29
move v0, v1
:goto_b
iget-object v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->d:Landroid/graphics/drawable/Drawable;
if-eqz v3, :cond_1f
iget-object v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->b:Landroid/support/v7/internal/view/menu/r;
invoke-virtual {v3}, Landroid/support/v7/internal/view/menu/r;->m()Z
move-result v3
if-eqz v3, :cond_20
...
.registers 4
iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->b:Landroid/support/v7/internal/view/menu/r;
...
move-result v0
if-eqz v0, :cond_10
iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->b:Landroid/support/v7/internal/view/menu/r;
...
const-string v0, " + Landroid/support/v7/internal/view/menu/ActionMenuItemView; onClick "
...
iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->e:Landroid/support/v7/internal/view/menu/p;
if-eqz v0, :cond_b
iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->e:Landroid/support/v7/internal/view/menu/p;
iget-object v1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->b:Landroid/support/v7/internal/view/menu/r;
invoke-interface {v0, v1}, Landroid/support/v7/internal/view/menu/p;->a(Landroid/support/v7/internal/view/menu/r;)Z
:cond_b
const-string v1, " - Landroid/support/v7/internal/view/menu/ActionMenuItemView; onClick"
invoke-static {}, Ldroidbox/apimonitor/Helper;->elapsedRealtime()Ljava/lang/String;
move-result-object v0
invoke-virtual {v0, v1}, Ljava/lang/String;->concat(Ljava/lang/String;)Ljava/lang/String;
move-result-object v0
...
invoke-static {v1}, Ldroidbox/apimonitor/Helper;->toString(Ljava/lang/Object;)Ljava/lang/String;
move-result-object v1
const-string v0, " + Landroid/support/v7/internal/view/menu/ActionMenuItemView; onLongClick "
invoke-virtual {v0, v1}, Ljava/lang/String;->concat(Ljava/lang/String;)Ljava/lang/String;
move-result-object v1
invoke-static {}, Ldroidbox/apimonitor/Helper;->elapsedRealtime()Ljava/lang/String;
move-result-object v0
...
:goto_8
move v2, v0
const-string v1, " - Landroid/support/v7/internal/view/menu/ActionMenuItemView; onLongClick"
invoke-static {}, Ldroidbox/apimonitor/Helper;->elapsedRealtime()Ljava/lang/String;
move-result-object v0
invoke-virtual {v0, v1}, Ljava/lang/String;->concat(Ljava/lang/String;)Ljava/lang/String;
move-result-object v0
...
iget-object v9, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->b:Landroid/support/v7/internal/view/menu/r;
...
:cond_45
if-nez v1, :cond_67
iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->d:Landroid/graphics/drawable/Drawable;
if-eqz v0, :cond_67
invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->getMeasuredWidth()I
move-result v0
iget-object v1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->d:Landroid/graphics/drawable/Drawable;
...
.registers 3
iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->g:Z
if-eq v0, p1, :cond_f
iput-boolean p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->g:Z
iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->b:Landroid/support/v7/internal/view/menu/r;
if-eqz v0, :cond_f
iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->b:Landroid/support/v7/internal/view/menu/r;
invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/r;->h()V
:cond_f
return-void
.end method
...
.registers 3
const/4 v0, 0x0
iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->d:Landroid/graphics/drawable/Drawable;
...
.registers 2
iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->e:Landroid/support/v7/internal/view/menu/p;
return-void
.end method
...
.registers 3
iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->c:Ljava/lang/CharSequence;
iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->c:Ljava/lang/CharSequence;
