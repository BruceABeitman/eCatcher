.class public final Lcom/spotify/mobile/android/ui/contextmenu/b/c/e;
...
.method protected final a(Landroid/content/Context;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    sget-object v2, Lcom/spotify/mobile/android/model/f;->a:[Ljava/lang/String;
...
.method protected final synthetic a(Landroid/database/Cursor;)Ljava/lang/Object;
    ...
    new-instance v0, Lcom/spotify/mobile/android/model/f;

    invoke-direct {v0}, Lcom/spotify/mobile/android/model/f;-><init>()V

    const-string v1, ""

    invoke-virtual {v0, p1, v1}, Lcom/spotify/mobile/android/model/f;->a(Landroid/database/Cursor;Ljava/lang/String;)V

    invoke-interface {v0}, Lcom/spotify/mobile/android/model/j;->a()Ljava/lang/String;

    move-result-object v1

    invoke-interface {v0}, Lcom/spotify/mobile/android/model/j;->b()Ljava/lang/String;
