...
.field private a:Landroid/support/v7/internal/view/menu/ab;
.field private b:I
...
.field protected h:Landroid/support/v7/internal/view/menu/ac;
.field private i:I
.field private j:I
...
return-void
.end method
.method public a(Landroid/view/ViewGroup;)Landroid/support/v7/internal/view/menu/ac;
.registers 5
iget-object v0, p0, Landroid/support/v7/internal/view/menu/i;->h:Landroid/support/v7/internal/view/menu/ac;
if-nez v0, :cond_1c
...
iput-object v0, p0, Landroid/support/v7/internal/view/menu/i;->h:Landroid/support/v7/internal/view/menu/ac;
iget-object v0, p0, Landroid/support/v7/internal/view/menu/i;->h:Landroid/support/v7/internal/view/menu/ac;
iget-object v1, p0, Landroid/support/v7/internal/view/menu/i;->e:Landroid/support/v7/internal/view/menu/n;
invoke-interface {v0, v1}, Landroid/support/v7/internal/view/menu/ac;->a(Landroid/support/v7/internal/view/menu/n;)V
const/4 v0, 0x1
...
.registers 7
instance-of v0, p2, Landroid/support/v7/internal/view/menu/ad;
if-eqz v0, :cond_d
check-cast p2, Landroid/support/v7/internal/view/menu/ad;
move-object v0, p2
:goto_7
invoke-virtual {p0, p1, v0}, Landroid/support/v7/internal/view/menu/i;->a(Landroid/support/v7/internal/view/menu/r;Landroid/support/v7/internal/view/menu/ad;)V
...
.registers 2
iput-object p1, p0, Landroid/support/v7/internal/view/menu/i;->a:Landroid/support/v7/internal/view/menu/ab;
return-void
.end method
.method public a(Landroid/support/v7/internal/view/menu/n;Z)V
.registers 4
iget-object v0, p0, Landroid/support/v7/internal/view/menu/i;->a:Landroid/support/v7/internal/view/menu/ab;
if-eqz v0, :cond_9
iget-object v0, p0, Landroid/support/v7/internal/view/menu/i;->a:Landroid/support/v7/internal/view/menu/ab;
...
return-void
.end method
.method public abstract a(Landroid/support/v7/internal/view/menu/r;Landroid/support/v7/internal/view/menu/ad;)V
.end method
.method public a(Landroid/support/v7/internal/view/menu/ag;)Z
.registers 3
iget-object v0, p0, Landroid/support/v7/internal/view/menu/i;->a:Landroid/support/v7/internal/view/menu/ab;
if-eqz v0, :cond_b
iget-object v0, p0, Landroid/support/v7/internal/view/menu/i;->a:Landroid/support/v7/internal/view/menu/ab;
...
if-eqz v1, :cond_71
iget-object v1, p0, Landroid/support/v7/internal/view/menu/i;->e:Landroid/support/v7/internal/view/menu/n;
invoke-virtual {v1}, Landroid/support/v7/internal/view/menu/n;->l()V
iget-object v1, p0, Landroid/support/v7/internal/view/menu/i;->e:Landroid/support/v7/internal/view/menu/n;
invoke-virtual {v1}, Landroid/support/v7/internal/view/menu/n;->k()Ljava/util/ArrayList;
...
invoke-virtual {p0, v1}, Landroid/support/v7/internal/view/menu/i;->a(Landroid/support/v7/internal/view/menu/r;)Z
move-result v2
if-eqz v2, :cond_6f
invoke-virtual {v0, v4}, Landroid/view/ViewGroup;->getChildAt(I)Landroid/view/View;
move-result-object v3
instance-of v2, v3, Landroid/support/v7/internal/view/menu/ad;
if-eqz v2, :cond_5e
move-object v2, v3
check-cast v2, Landroid/support/v7/internal/view/menu/ad;
invoke-interface {v2}, Landroid/support/v7/internal/view/menu/ad;->a()Landroid/support/v7/internal/view/menu/r;
...
:cond_50
iget-object v1, p0, Landroid/support/v7/internal/view/menu/i;->h:Landroid/support/v7/internal/view/menu/ac;
check-cast v1, Landroid/view/ViewGroup;
