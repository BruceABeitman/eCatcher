.class public Lcom/pinguo/album/data/MediaDetails;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/pinguo/album/data/MediaDetails$FlashState;
    }
.end annotation
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/pinguo/album/data/MediaDetails;->mDetails:Ljava/util/TreeMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/pinguo/album/data/MediaDetails;->mUnits:Ljava/util/HashMap;

    return-void
.end method

.method public static extractExifInfo(Lcom/pinguo/album/data/MediaDetails;Ljava/lang/String;)V
    .registers 11
    ...
    invoke-static {p0, v3, v4, v5}, Lcom/pinguo/album/data/MediaDetails;->setExifData(Lcom/pinguo/album/data/MediaDetails;Landroid/media/ExifInterface;Ljava/lang/String;I)V
    ...
    sget-boolean v4, Lcom/pinguo/lib/ApiHelper;->AFTER_HONEYCOMB:Z
    ...
    invoke-virtual {p0, v4, v5}, Lcom/pinguo/album/data/MediaDetails;->addDetail(ILjava/lang/Object;)V

    const/16 v4, 0x67

    const v5, 0x7f08009c

    invoke-virtual {p0, v4, v5}, Lcom/pinguo/album/data/MediaDetails;->setUnit(II)V
    :try_end_6f
    ...
    invoke-static {v4, v5, v2}, Lcom/pinguo/album/common/PGLog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    goto :goto_6f
.end method

.method private static setExifData(Lcom/pinguo/album/data/MediaDetails;Landroid/media/ExifInterface;Ljava/lang/String;I)V
    .registers 7
    ...
    new-instance v0, Lcom/pinguo/album/data/MediaDetails$FlashState;
    ...
    invoke-direct {v0, v2}, Lcom/pinguo/album/data/MediaDetails$FlashState;-><init>(I)V

    invoke-virtual {p0, p3, v0}, Lcom/pinguo/album/data/MediaDetails;->addDetail(ILjava/lang/Object;)V
    ...
    :cond_1f
    invoke-virtual {p0, p3, v1}, Lcom/pinguo/album/data/MediaDetails;->addDetail(ILjava/lang/Object;)V
...
.method public addDetail(ILjava/lang/Object;)V
    ...
    iget-object v0, p0, Lcom/pinguo/album/data/MediaDetails;->mDetails:Ljava/util/TreeMap;
...
.method public getUnit(I)I
    ...
    iget-object v0, p0, Lcom/pinguo/album/data/MediaDetails;->mUnits:Ljava/util/HashMap;
