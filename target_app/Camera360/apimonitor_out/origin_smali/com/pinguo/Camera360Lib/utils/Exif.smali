.class public Lcom/pinguo/Camera360Lib/utils/Exif;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;
    }
.end annotation
...
.method public static exifToJpegData([B[B)[B
    ...
    invoke-static {p0}, Lcom/pinguo/Camera360Lib/utils/Exif;->isJpeg([B)Z
    ...
    const-string/jumbo v9, "jpeg data \u6570\u636e\u4e0d\u6b63\u786e,"
    ...
    invoke-static {p0, v4, v10, v9}, Lcom/pinguo/Camera360Lib/utils/Exif;->pack([BIIZ)I
    ...
    invoke-static {v7, v8}, Lcom/pinguo/Camera360Lib/log/GLogger;->i(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static exifToJpegFile(Ljava/lang/String;Ljava/lang/String;[B)V
    ...
    :try_start_1a
    invoke-static {v1, v3, p2}, Lcom/pinguo/Camera360Lib/utils/Exif;->exifToJpegStream(Ljava/io/InputStream;Ljava/io/OutputStream;[B)V
    :try_end_1d
...
.method private static exifToJpegStream(Ljava/io/InputStream;Ljava/io/OutputStream;[B)V
    ...
    invoke-static {v6, v0}, Lcom/pinguo/Camera360Lib/utils/Exif;->marker([BI)I
    ...
    invoke-static {v6, v11, v0, v1}, Lcom/pinguo/Camera360Lib/utils/Exif;->pack([BIIZ)I
...
.method private static getExifAppData(Ljava/io/InputStream;III)[B
    ...
    :cond_4d
    invoke-static {v1, v10, v10, v9}, Lcom/pinguo/Camera360Lib/utils/Exif;->pack([BIIZ)I
    ...
    invoke-static {v1, v7, v8, v9}, Lcom/pinguo/Camera360Lib/utils/Exif;->pack([BIIZ)I
...
.method public static getExifData(Ljava/lang/String;)[B
    ...
    :cond_6f
    :try_start_6f
    invoke-static {v7, v8}, Lcom/pinguo/Camera360Lib/utils/Exif;->getLen(II)I
    ...
    invoke-static {v6, v7, v8, v0}, Lcom/pinguo/Camera360Lib/utils/Exif;->getExifAppData(Ljava/io/InputStream;III)[B
    :try_end_7a
    ...
    :try_start_92
    invoke-static {v6, v10, v11}, Lcom/pinguo/Camera360Lib/utils/Exif;->skip(Ljava/io/InputStream;J)Z
...
.method public static getExifData([B)[B
    ...
    invoke-static {p0}, Lcom/pinguo/Camera360Lib/utils/Exif;->getExifDataFromTo([B)Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;
    ...
    :cond_a
    #getter for: Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;->length:I
    invoke-static {v1}, Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;->access$0(Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;)I

    move-result v2

    new-array v0, v2, [B

    #getter for: Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;->from:I
    invoke-static {v1}, Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;->access$1(Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;)I
...
.method private static getExifDataFromTo([B)Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;
    .registers 13
    ...
    invoke-static {p0, v7, v8, v9}, Lcom/pinguo/Camera360Lib/utils/Exif;->pack([BIIZ)I
    ...
    invoke-static {p0, v7, v10, v9}, Lcom/pinguo/Camera360Lib/utils/Exif;->pack([BIIZ)I

    move-result v7

    if-nez v7, :cond_7f

    new-instance v0, Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;

    invoke-direct {v0, v6}, Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;-><init>(Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;)V

    add-int/lit8 v6, v4, -0x2

    #setter for: Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;->from:I
    invoke-static {v0, v6}, Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;->access$3(Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;I)V

    add-int/lit8 v6, v2, 0x2

    #setter for: Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;->length:I
    invoke-static {v0, v6}, Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;->access$4(Lcom/pinguo/Camera360Lib/utils/Exif$FromTo;I)V
...
.method public static getOrientation([B)I
    ...
    invoke-static {p0, v5, v13, v9}, Lcom/pinguo/Camera360Lib/utils/Exif;->pack([BIIZ)I
    ...
    invoke-static {p0, v5, v12, v9}, Lcom/pinguo/Camera360Lib/utils/Exif;->pack([BIIZ)I
    ...
    invoke-static {p0, v10, v13, v9}, Lcom/pinguo/Camera360Lib/utils/Exif;->pack([BIIZ)I
    ...
    invoke-static {p0, v10, v12, v9}, Lcom/pinguo/Camera360Lib/utils/Exif;->pack([BIIZ)I
    ...
    invoke-static {p0, v10, v13, v3}, Lcom/pinguo/Camera360Lib/utils/Exif;->pack([BIIZ)I
    ...
    invoke-static {p0, v10, v12, v3}, Lcom/pinguo/Camera360Lib/utils/Exif;->pack([BIIZ)I
    ...
    :cond_c1
    invoke-static {p0, v5, v12, v3}, Lcom/pinguo/Camera360Lib/utils/Exif;->pack([BIIZ)I
    ...
    invoke-static {p0, v9, v12, v3}, Lcom/pinguo/Camera360Lib/utils/Exif;->pack([BIIZ)I

    move-result v7

    invoke-static {v7}, Lcom/pinguo/Camera360Lib/utils/Exif;->getOrientation(I)I
...
.method public static getPhotoOrientation(Ljava/lang/String;)I
    ...
    :try_start_0
    invoke-static {p0}, Lcom/pinguo/Camera360Lib/utils/Exif;->getExifOrientationFlag(Ljava/lang/String;)I

    move-result v1

    invoke-static {v1}, Lcom/pinguo/Camera360Lib/utils/Exif;->getOrientation(I)I
    :try_end_7
    ...
    invoke-static {v2, v0}, Lcom/pinguo/Camera360Lib/log/GLogger;->i(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static isJpeg([B)Z
    ...
    invoke-static {p0, v1}, Lcom/pinguo/Camera360Lib/utils/Exif;->marker([BI)I
