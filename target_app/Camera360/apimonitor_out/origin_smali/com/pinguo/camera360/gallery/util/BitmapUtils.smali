.class public Lcom/pinguo/camera360/gallery/util/BitmapUtils;
...
.method public static compress(Landroid/graphics/Bitmap;Ljava/lang/String;I)Z
    .registers 10
    ...
    new-instance v4, LvStudio/Android/GPhoto/GPhotoJNI;

    invoke-direct {v4}, LvStudio/Android/GPhoto/GPhotoJNI;-><init>()V

    invoke-virtual {v4, p0, p1, p2}, LvStudio/Android/GPhoto/GPhotoJNI;->SaveBitmapToJpgFile(Landroid/graphics/Bitmap;Ljava/lang/String;I)Z
    ...
    .catch Ljava/lang/Exception; {:try_start_16 .. :try_end_1b} :catch_2b
...
.method public static compressToBytes(Landroid/graphics/Bitmap;)[B
    ...
    invoke-static {p0, v0}, Lcom/pinguo/camera360/gallery/util/BitmapUtils;->compressToBytes(Landroid/graphics/Bitmap;I)[B
...
.method public static computeSampleSize(F)I
    ...
    invoke-static {v0}, Lcom/pinguo/camera360/gallery/util/Utils;->nextPowerOf2(I)I
...
.method public static computeSampleSize(IIII)I
    ...
    invoke-static {p0, p1, p2, p3}, Lcom/pinguo/camera360/gallery/util/BitmapUtils;->computeInitialSampleSize(IIII)I
...
.method public static computeSampleSizeLarger(F)I
    ...
    invoke-static {v0}, Lcom/pinguo/camera360/gallery/util/Utils;->prevPowerOf2(I)I
...
.method public static resizeAndCropCenter(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0}, Lcom/pinguo/camera360/gallery/util/BitmapUtils;->getConfig(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;
...
.method public static resizeDownBySideLength(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    :cond_19
    invoke-static {p0, v0, p2}, Lcom/pinguo/camera360/gallery/util/BitmapUtils;->resizeBitmapByScale(Landroid/graphics/Bitmap;FZ)Landroid/graphics/Bitmap;
