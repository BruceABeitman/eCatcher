.class public Lus/pinguo/androidsdk/pgedit/PGEditCropView$DrawCrop916;
...
.registers 8
const/4 v5, 0x0
iput-object p1, p0, Lus/pinguo/androidsdk/pgedit/PGEditCropView$DrawCrop916;->this$0:Lus/pinguo/androidsdk/pgedit/PGEditCropView;
...
#getter for: Lus/pinguo/androidsdk/pgedit/PGEditCropView;->mCrop916Rect:Landroid/graphics/Rect;
invoke-static {p1}, Lus/pinguo/androidsdk/pgedit/PGEditCropView;->access$36(Lus/pinguo/androidsdk/pgedit/PGEditCropView;)Landroid/graphics/Rect;
...
iput-object v0, p0, Lus/pinguo/androidsdk/pgedit/PGEditCropView$DrawCrop916;->centerRect:Landroid/graphics/Rect;
...
invoke-virtual {p0}, Lus/pinguo/androidsdk/pgedit/PGEditCropView$DrawCrop916;->changeRoundValue()V
...
.registers 3
const v0, 0x3fe3d70a
invoke-virtual {p0, p1, v0}, Lus/pinguo/androidsdk/pgedit/PGEditCropView$DrawCrop916;->scaleLeftBottom(Landroid/view/MotionEvent;F)V
return-void
.end method
.method public scaleLeftTop(Landroid/view/MotionEvent;)V
.registers 3
const v0, 0x3fe3d70a
invoke-virtual {p0, p1, v0}, Lus/pinguo/androidsdk/pgedit/PGEditCropView$DrawCrop916;->scaleLeftTop(Landroid/view/MotionEvent;F)V
return-void
.end method
.method public scaleRightBottom(Landroid/view/MotionEvent;)V
.registers 3
const v0, 0x3fe3d70a
invoke-virtual {p0, p1, v0}, Lus/pinguo/androidsdk/pgedit/PGEditCropView$DrawCrop916;->scaleRightBottom(Landroid/view/MotionEvent;F)V
return-void
.end method
.method public scaleRightTop(Landroid/view/MotionEvent;)V
.registers 3
const v0, 0x3fe3d70a
invoke-virtual {p0, p1, v0}, Lus/pinguo/androidsdk/pgedit/PGEditCropView$DrawCrop916;->scaleRightTop(Landroid/view/MotionEvent;F)V
return-void
.end method