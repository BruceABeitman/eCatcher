...
.registers 12
const v0, 0x1030010
invoke-direct {p0, p1, v0}, Lcom/tencent/open/h;-><init>(Landroid/content/Context;I)V
...
:goto_70
:try_end_70
.catch Ljava/lang/Exception; {:try_start_42 .. :try_end_70} :catch_93
...
:try_end_16
.catch Lorg/json/JSONException; {:try_start_5 .. :try_end_16} :catch_1a
const/4 v0, 0x1
if-ne v1, v0, :cond_4
goto :goto_4
:catch_1a
...
:try_end_3c
.catch Lorg/json/JSONException; {:try_start_1 .. :try_end_3c} :catch_3d
goto :goto_20
:catch_3d
move-exception v0
invoke-virtual {v0}, Lorg/json/JSONException;->printStackTrace()V
...
invoke-virtual {v0, v1}, Landroid/widget/Toast;->setDuration(I)V
:try_end_6b
.catch Lorg/json/JSONException; {:try_start_44 .. :try_end_6b} :catch_3d
goto :goto_4f
.end method
...
.registers 1
invoke-super {p0}, Lcom/tencent/open/h;->onBackPressed()V
return-void
.end method
...
.registers 5
const-string v1, " + Lcom/tencent/open/PKDialog; onCreate"
...
const/4 v2, 0x1
invoke-super {p0, p1}, Lcom/tencent/open/h;->onCreate(Landroid/os/Bundle;)V
