.class public Lcom/pinguo/album/data/source/LocalSource;
...
iput-object v0, p0, Lcom/pinguo/album/data/source/LocalSource;->mUriMatcher:Landroid/content/UriMatcher;
iput-object p1, p0, Lcom/pinguo/album/data/source/LocalSource;->mApplication:Lcom/pinguo/album/PGAlbumApp;
new-instance v0, Lcom/pinguo/album/data/PathMatcher;
invoke-direct {v0}, Lcom/pinguo/album/data/PathMatcher;-><init>()V
iput-object v0, p0, Lcom/pinguo/album/data/source/LocalSource;->mMatcher:Lcom/pinguo/album/data/PathMatcher;
iget-object v0, p0, Lcom/pinguo/album/data/source/LocalSource;->mMatcher:Lcom/pinguo/album/data/PathMatcher;
...
iget-object v0, p0, Lcom/pinguo/album/data/source/LocalSource;->mUriMatcher:Landroid/content/UriMatcher;
...
invoke-static {v4, p2}, Lcom/pinguo/album/data/source/LocalSource;->getMediaType(Ljava/lang/String;I)I
move-result v3
...
:pswitch_40
new-instance v4, Lcom/pinguo/album/data/MediaPath;
const-string/jumbo v5, "/local/image"
invoke-static {v2}, Ljava/lang/String;->valueOf(I)Ljava/lang/String;
move-result-object v6
invoke-direct {v4, v5, v6}, Lcom/pinguo/album/data/MediaPath;-><init>(Ljava/lang/String;Ljava/lang/String;)V
goto :goto_26
:pswitch_4d
new-instance v4, Lcom/pinguo/album/data/MediaPath;
const-string/jumbo v5, "/local/video"
invoke-static {v2}, Ljava/lang/String;->valueOf(I)Ljava/lang/String;
move-result-object v6
invoke-direct {v4, v5, v6}, Lcom/pinguo/album/data/MediaPath;-><init>(Ljava/lang/String;Ljava/lang/String;)V
goto :goto_26
...
.registers 7
iget-object v0, p0, Lcom/pinguo/album/data/source/LocalSource;->mApplication:Lcom/pinguo/album/PGAlbumApp;
const-string/jumbo v1, "LocalSource"
...
invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
move-result-object v2
iget-object v3, p0, Lcom/pinguo/album/data/source/LocalSource;->mMatcher:Lcom/pinguo/album/data/PathMatcher;
invoke-virtual {p1}, Lcom/pinguo/album/data/MediaPath;->getPrefix()Ljava/lang/String;
move-result-object v4
...
iget-object v1, p0, Lcom/pinguo/album/data/source/LocalSource;->mMatcher:Lcom/pinguo/album/data/PathMatcher;
invoke-virtual {p1}, Lcom/pinguo/album/data/MediaPath;->getPrefix()Ljava/lang/String;
move-result-object v2
...
throw v1
:pswitch_54
new-instance v1, Lcom/pinguo/album/data/source/LocalAlbumSet;
iget-object v2, p0, Lcom/pinguo/album/data/source/LocalSource;->mApplication:Lcom/pinguo/album/PGAlbumApp;
invoke-direct {v1, p1, v2}, Lcom/pinguo/album/data/source/LocalAlbumSet;-><init>(Lcom/pinguo/album/data/MediaPath;Lcom/pinguo/album/PGAlbumApp;)V
:goto_5b
return-object v1
:pswitch_5c
new-instance v1, Lcom/pinguo/album/data/source/LocalAlbum;
invoke-virtual {p1}, Lcom/pinguo/album/data/MediaPath;->getIdentity()Ljava/lang/String;
move-result-object v2
const/4 v3, 0x1
invoke-direct {v1, p1, v0, v2, v3}, Lcom/pinguo/album/data/source/LocalAlbum;-><init>(Lcom/pinguo/album/data/MediaPath;Lcom/pinguo/album/PGAlbumApp;Ljava/lang/String;Z)V
goto :goto_5b
:pswitch_67
new-instance v1, Lcom/pinguo/album/data/source/LocalAlbum;
invoke-virtual {p1}, Lcom/pinguo/album/data/MediaPath;->getIdentity()Ljava/lang/String;
...
goto :goto_5b
:pswitch_72
new-instance v1, Lcom/pinguo/album/data/image/LocalImage;
iget-object v2, p0, Lcom/pinguo/album/data/source/LocalSource;->mApplication:Lcom/pinguo/album/PGAlbumApp;
invoke-virtual {p1}, Lcom/pinguo/album/data/MediaPath;->getIdentity()Ljava/lang/String;
move-result-object v3
invoke-direct {v1, p1, v2, v3}, Lcom/pinguo/album/data/image/LocalImage;-><init>(Lcom/pinguo/album/data/MediaPath;Lcom/pinguo/album/PGAlbumApp;Ljava/lang/String;)V
goto :goto_5b
:pswitch_7e
new-instance v1, Lcom/pinguo/album/data/video/LocalVideo;
iget-object v2, p0, Lcom/pinguo/album/data/source/LocalSource;->mApplication:Lcom/pinguo/album/PGAlbumApp;
invoke-virtual {p1}, Lcom/pinguo/album/data/MediaPath;->getIdentity()Ljava/lang/String;
move-result-object v3
invoke-direct {v1, p1, v2, v3}, Lcom/pinguo/album/data/video/LocalVideo;-><init>(Lcom/pinguo/album/data/MediaPath;Lcom/pinguo/album/PGAlbumApp;Ljava/lang/String;)V
goto :goto_5b
:pswitch_data_8a
.packed-switch 0x0
:pswitch_54
...
const/4 v4, 0x0
:try_start_3
iget-object v3, p0, Lcom/pinguo/album/data/source/LocalSource;->mUriMatcher:Landroid/content/UriMatcher;
...
:pswitch_3b
const/4 v3, 0x2
invoke-direct {p0, p1, v3}, Lcom/pinguo/album/data/source/LocalSource;->getAlbumPath(Landroid/net/Uri;I)Lcom/pinguo/album/data/MediaPath;
move-result-object v4
goto :goto_c
:pswitch_41
const/4 v3, 0x4
...
:catch_4d
move-exception v0
const-string/jumbo v3, "LocalSource"
new-instance v5, Ljava/lang/StringBuilder;
...
.registers 2
iget-object v0, p0, Lcom/pinguo/album/data/source/LocalSource;->mClient:Landroid/content/ContentProviderClient;
if-eqz v0, :cond_c
iget-object v0, p0, Lcom/pinguo/album/data/source/LocalSource;->mClient:Landroid/content/ContentProviderClient;
invoke-virtual {v0}, Landroid/content/ContentProviderClient;->release()Z
const/4 v0, 0x0
iput-object v0, p0, Lcom/pinguo/album/data/source/LocalSource;->mClient:Landroid/content/ContentProviderClient;
:cond_c
return-void
.end method
