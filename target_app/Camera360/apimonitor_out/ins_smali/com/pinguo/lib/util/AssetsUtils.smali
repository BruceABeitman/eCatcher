.class public Lcom/pinguo/lib/util/AssetsUtils;
...
.registers 1
const-class v0, Lcom/pinguo/lib/util/AssetsUtils;
invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;
move-result-object v0
sput-object v0, Lcom/pinguo/lib/util/AssetsUtils;->TAG:Ljava/lang/String;
return-void
.end method
...
.registers 15
sget-object v9, Lcom/pinguo/lib/util/AssetsUtils;->TAG:Ljava/lang/String;
...
if-eqz v8, :cond_56
invoke-static {v8}, Lcom/pinguo/lib/util/FileUtils;->checkFolder(Ljava/io/File;)Z
move-result v9
if-nez v9, :cond_56
...
:try_start_7a
invoke-static {v7}, Lcom/pinguo/lib/util/FileUtils;->close(Ljava/io/OutputStream;)V
:try_end_7d
.catchall {:try_start_7a .. :try_end_7d} :catchall_9d
.catch Ljava/lang/Exception; {:try_start_7a .. :try_end_7d} :catch_8d
invoke-static {v4}, Lcom/pinguo/lib/util/FileUtils;->close(Ljava/io/InputStream;)V
move-object v3, v4
:goto_81
return-void
:cond_82
...
:goto_89
:try_start_89
invoke-static {v6}, Lcom/pinguo/lib/util/FileUtils;->close(Ljava/io/OutputStream;)V
throw v9
:catch_8d
:try_end_8d
...
:goto_8f
sget-object v9, Lcom/pinguo/lib/util/AssetsUtils;->TAG:Ljava/lang/String;
invoke-static {v9, v2}, Lcom/pinguo/lib/log/GLogger;->e(Ljava/lang/String;Ljava/lang/Throwable;)V
:try_end_94
.catchall {:try_start_8f .. :try_end_94} :catchall_98
invoke-static {v3}, Lcom/pinguo/lib/util/FileUtils;->close(Ljava/io/InputStream;)V
goto :goto_81
:catchall_98
move-exception v9
:goto_99
...
move-result-object v11
invoke-static {v11}, Lcom/pinguo/lib/util/FileUtils;->checkFolder(Ljava/io/File;)Z
move-result v12
if-nez v12, :cond_67
...
:try_start_b5
invoke-static {v9}, Lcom/pinguo/lib/util/FileUtils;->close(Ljava/io/OutputStream;)V
:try_end_b8
.catchall {:try_start_b5 .. :try_end_b8} :catchall_e3
.catch Ljava/lang/Exception; {:try_start_b5 .. :try_end_b8} :catch_d5
invoke-static {v7}, Lcom/pinguo/lib/util/FileUtils;->close(Ljava/io/InputStream;)V
move-object v6, v7
:goto_bc
return-void
:cond_bd
...
invoke-static {v6}, Lcom/pinguo/lib/util/FileUtils;->close(Ljava/io/InputStream;)V
goto :goto_bc
:catchall_de
move-exception v12
:goto_df
...
.registers 5
invoke-static {p0, p1}, Lcom/pinguo/lib/util/AssetsUtils;->getAssetsFileData(Landroid/content/Context;Ljava/lang/String;)[B
move-result-object v0
...
return-object v1
.end method
.method public static getAssetsFileContentW(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
.registers 11
...
invoke-direct {v6, v0, v7, v4, v8}, Ljava/lang/String;-><init>([BIILjava/lang/String;)V
...
:catch_33
move-exception v2
sget-object v6, Lcom/pinguo/lib/util/AssetsUtils;->TAG:Ljava/lang/String;
...
invoke-static {v2}, Lcom/pinguo/lib/util/FileUtils;->getStreamData(Ljava/io/InputStream;)[B
:try_end_12
