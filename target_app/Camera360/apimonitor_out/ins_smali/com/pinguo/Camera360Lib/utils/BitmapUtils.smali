.class public final Lcom/pinguo/Camera360Lib/utils/BitmapUtils;
...
.registers 1
const-class v0, Lcom/pinguo/Camera360Lib/utils/BitmapUtils;
invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;
move-result-object v0
sput-object v0, Lcom/pinguo/Camera360Lib/utils/BitmapUtils;->TAG:Ljava/lang/String;
return-void
.end method
...
return-void
.end method
.method public static getDecodeOptions(III)Landroid/graphics/BitmapFactory$Options;
.registers 11
const/4 v7, 0x0
...
goto :goto_c
.end method
.method public static getDecodeOptions(Ljava/lang/String;I)Landroid/graphics/BitmapFactory$Options;
.registers 7
const/4 v4, 0x0
const/4 v3, -0x1
const/4 v2, 0x1
...
return-object v0
:cond_1d
invoke-static {v0, p1, v2}, Lcom/pinguo/Camera360Lib/utils/BitmapUtils;->getSampleSize(Landroid/graphics/BitmapFactory$Options;IZ)I
move-result v1
...
cmpg-float v3, v3, v4
if-ltz v3, :cond_21
invoke-static {p0, v1, v1, p2}, Lcom/pinguo/Camera360Lib/utils/BitmapUtils;->scaleBitmap(Landroid/graphics/Bitmap;FFI)Landroid/graphics/Bitmap;
...
:cond_3b
const/4 v8, 0x1
invoke-static {v4, p1, v8}, Lcom/pinguo/Camera360Lib/utils/BitmapUtils;->getSampleSize(Landroid/graphics/BitmapFactory$Options;IZ)I
move-result v8
iput v8, v4, Landroid/graphics/BitmapFactory$Options;->inSampleSize:I
const/4 v8, 0x0
iput-boolean v8, v4, Landroid/graphics/BitmapFactory$Options;->inJustDecodeBounds:Z
...
move-result v5
invoke-static {v5}, Lcom/pinguo/Camera360Lib/utils/Exif;->getOrientation(I)I
:try_end_63
.catch Ljava/io/IOException; {:try_start_53 .. :try_end_63} :catch_70
move-result v6
:cond_64
:goto_64
invoke-static {v0, p1, v6}, Lcom/pinguo/Camera360Lib/utils/BitmapUtils;->scaleBitmap(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
move-result-object v7
goto :goto_3a
:catch_69
move-exception v3
sget-object v8, Lcom/pinguo/Camera360Lib/utils/BitmapUtils;->TAG:Ljava/lang/String;
invoke-static {v8, v3}, Lcom/pinguo/Camera360Lib/log/GLogger;->e(Ljava/lang/String;Ljava/lang/Throwable;)V
goto :goto_3a
:catch_70
move-exception v1
const/4 v6, 0x0
...
if-eq v8, v9, :cond_4
const/4 v8, 0x1
invoke-static {v5, p1, v8}, Lcom/pinguo/Camera360Lib/utils/BitmapUtils;->getSampleSize(Landroid/graphics/BitmapFactory$Options;IZ)I
move-result v3
...
const/4 v6, 0x0
if-eqz p2, :cond_65
invoke-static {p0}, Lcom/pinguo/Camera360Lib/utils/Exif;->getOrientation([B)I
move-result v6
:cond_65
invoke-static {v0, p1, v6}, Lcom/pinguo/Camera360Lib/utils/BitmapUtils;->scaleBitmap(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
move-result-object v7
...
move-exception v4
sget-object v8, Lcom/pinguo/Camera360Lib/utils/BitmapUtils;->TAG:Ljava/lang/String;
invoke-static {v8, v4}, Lcom/pinguo/Camera360Lib/log/GLogger;->e(Ljava/lang/String;Ljava/lang/Throwable;)V
goto :goto_4
.end method
...
:catch_7f
move-exception v7
sget-object v0, Lcom/pinguo/Camera360Lib/utils/BitmapUtils;->TAG:Ljava/lang/String;
invoke-static {v0, v7}, Lcom/pinguo/Camera360Lib/log/GLogger;->e(Ljava/lang/String;Ljava/lang/Throwable;)V
