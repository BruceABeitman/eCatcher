...
const-string/jumbo v5, "apn type : "
...
new-instance v4, Ljava/lang/StringBuilder;
invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V
const-string/jumbo v5, "apn type : ADD PROXY"
invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
move-result-object v4
...
:try_end_15a
.catch Ljava/lang/Exception; {:try_start_9 .. :try_end_15a} :catch_19a
:cond_15a
if-gtz v1, :cond_179
invoke-static {}, Lcom/baidu/location/g;->try()Landroid/os/Handler;
move-result-object v0
...
invoke-virtual {v0}, Landroid/os/Message;->sendToTarget()V
:try_end_195
.catch Ljava/lang/Exception; {:try_start_180 .. :try_end_195} :catch_19a
:goto_195
