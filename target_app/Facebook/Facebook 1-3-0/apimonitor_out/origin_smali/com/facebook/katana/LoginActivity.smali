...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/facebook/katana/LoginActivity$LoginAppSessionListener;
    }
.end annotation
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v8, p0, Lcom/facebook/katana/LoginActivity;->mAddAccountMode:Z
    ...
    invoke-virtual {v9}, Lcom/facebook/katana/binding/AppSession$LoginStatus;->ordinal()I
    ...
    invoke-static {p0, v8}, Lcom/facebook/katana/provider/UserValuesManager;->setRegisterRingtone(Landroid/content/Context;Z)V
    :try_end_4c
    .catch Ljava/io/IOException; {:try_start_2e .. :try_end_4c} :catch_ea

    :cond_4c
    :goto_4c
    iget-boolean v8, p0, Lcom/facebook/katana/LoginActivity;->mAddAccountMode:Z
    ...
    invoke-virtual {p0, v8}, Lcom/facebook/katana/LoginActivity;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v8}, Lcom/facebook/katana/LoginActivity;->setContentView(I)V

    const v8, 0x7f0b00b4

    invoke-virtual {p0, v8}, Lcom/facebook/katana/LoginActivity;->findViewById(I)Landroid/view/View;
    ...
    iput-object v8, p0, Lcom/facebook/katana/LoginActivity;->mErrorMessage:Ljava/lang/String;

    :cond_e1
    new-instance v8, Lcom/facebook/katana/LoginActivity$LoginAppSessionListener;

    const/4 v9, 0x0

    invoke-direct {v8, p0, v9}, Lcom/facebook/katana/LoginActivity$LoginAppSessionListener;-><init>(Lcom/facebook/katana/LoginActivity;Lcom/facebook/katana/LoginActivity$LoginAppSessionListener;)V

    iput-object v8, p0, Lcom/facebook/katana/LoginActivity;->mAppSessionListener:Lcom/facebook/katana/binding/AppSessionListener;
