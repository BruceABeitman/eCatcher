...
return-object v1
.end method
.method public static showSubMenu(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;[ILandroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/AlertDialog;
.registers 8
new-instance v0, Landroid/app/AlertDialog$Builder;
invoke-direct {v0, p0}, Landroid/app/AlertDialog$Builder;-><init>(Landroid/content/Context;)V
if-eqz p1, :cond_a
invoke-virtual {v0, p1}, Landroid/app/AlertDialog$Builder;->setTitle(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;
:cond_a
new-instance v1, Lcom/facebook/katana/AlertDialogs$1;
invoke-direct {v1, p2, p0, p3}, Lcom/facebook/katana/AlertDialogs$1;-><init>([Ljava/lang/String;Landroid/content/Context;[I)V
invoke-virtual {v0, v1, p4}, Landroid/app/AlertDialog$Builder;->setAdapter(Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
if-eqz p5, :cond_17
