...
plot_find_manifest <- function() {
  ...
  for (log in log_list$name) {
    ...
    plot(sortedm_iter, sortedm$ranking, type="l", ylab="Rank (%)", xlab="", cex.axis=1.5, cex.lab=2, las=1, ylim=c(0,100), xlim=c(0,400), lwd=1, lty=1, col="black", xaxs="i", yaxs="i")
    ...
    legend(85, -9.5, legend_labels, bty = "n", horiz=TRUE,
