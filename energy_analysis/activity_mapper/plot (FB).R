...
#8app_phoneBase_energy=app_phone_base_energy)
  ...
  #par(mar=c(5,5,.1,.1))
  par(mar=c(25,6,1,.1))
  plot(appm$app_time, appm$app_cpu_energy, type="l", lwd=2, lty=5, pch=1, cex.axis=1.5, cex.lab=2, col="red",
  ...
  legend(20, 700, legend_labels, 
         cex=1.25, pt.cex=.75, lty=c(2,2,2), lwd=3, col=c("red", "green", "blue", "orange"), pch=c(NA, 19, 19, 23), horiz=TRUE);
